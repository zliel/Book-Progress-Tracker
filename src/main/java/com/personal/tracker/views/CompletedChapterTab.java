...
public class CompletedChapterTab {
  public static Tab createCompletedChaptersTab(
      TableView<CompletedChapter> completedChapters, TableView<Chapter> chapters) {
    ...
    submitButton.setOnAction(
        event -> {
          ...
          if (Add.isCompletedChapterInputBlank(
              studentFirstName, studentLastName, chapterNum, bookTitle)) {
            ...
            ListIterator<CompletedChapter> chapterListIterator =
            ...
            while (chapterListIterator.hasNext()) {
              ...
              if (studentId != null
                  && currentChapter.studentIdIsEqual(studentId)
                  && currentChapter.chapterIsEqual(chapterNum, bookTitle)) {
            ...
            if (!chapterExists) {
              ...
              //        chapterNumberLabel.setText("Chapter Number: " +
              // chapterNumberSpinner.getValue());
              ...
              completedChapters
                  ...
                  .add(
                      new CompletedChapter(
                          studentId, chapterNum, Date.valueOf(date), bookTitle, chapterTitle));
            } else {
    ...
    deleteButton.setOnAction(
        e -> {
          ...
          CompletedChapter selectedCompletedChapter =
              completedChapters.getSelectionModel().getSelectedItem();
          ...
          Delete.deleteCompletedChapter(
              selectedCompletedChapter.getStudentId(),
              selectedCompletedChapter.getBookTitle(),
              selectedCompletedChapter.getChapterNumber());
        });
