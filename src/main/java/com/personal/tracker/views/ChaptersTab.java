...
public class ChaptersTab {
  public static Tab createChaptersTab(
      TableView<Chapter> chapters, TableView<CompletedChapter> completedChapters) {
    ...
    deleteButton.setOnAction(
        e -> {
          ...
          // Loop through the CompletedChapters TableView and remove the ones that match the chapter
          // we're deleting
          ...
          while (completedChapterIterator.hasNext()) {
            ...
            if (currentChapter.chapterIsEqual(
                selectedChapter.getChapterKey(), currentChapter.getBookTitle())) {
    ...
    submitButton.setOnAction(
        event -> {
          ...
          while (chapterListIterator.hasNext()) {
            ...
            if (currentChapter.getChapterKey().equals(chapterNum)
                && currentChapter.getChapterTitle().equalsIgnoreCase(chapterTitle)
                && currentChapter.getBookTitle().equalsIgnoreCase(bookTitle)) {
              System.err.println("THAT CHAPTER ALREADY EXISTS");
              // Make a warning label for this to show the user
              chapterExists = true;
            } else if (currentChapter.getChapterKey().equals(chapterNum)
                && currentChapter.getBookTitle().equalsIgnoreCase(bookTitle)) {
